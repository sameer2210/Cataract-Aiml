...
//            const data = await axios.post('http://localhost:3000/projects/create', {
//                 projectName
//             })
//             navigate('/')            
//         } catch (error) {
  ...
  return (
    <main className="h-screen flex items-center justify-evenly gap-6 bg-gradient-to-br from-[#0f172a] to-[#134e4a] px-4 py-8">
      <motion.section
        ...
        className="h-1/3 w-1/3 flex flex-col gap-8 justify-center items-center p-8 rounded-2xl bg-white/10 border border-white/20 shadow-xl backdrop-blur-md"
      >
        <h2 className="text-4xl font-bold text-white text-center mb-6 ">
           Create a New Project
        </h2>

        <form onSubmit={handleSubmit} className=" flex flex-col gap-8 justify-between items-center ">
          <input
            type="text"
            name="projectName"
